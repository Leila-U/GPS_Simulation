...
VEHICLE_NETWORK = os.path.join(INPUT, "Network", "TransportNetwork.gdb", "VehicleNetwork", "VehicleNetwork_ND")
BIKE_NETWORK = os.path.join(INPUT, "Network", "TransportNetwork.gdb", "BikeNetwork", "BikeNetwork_ND")
TRANSIT_NETWORK = os.path.join(INPUT, "Network", "TransportNetwork.gdb", "TransitNetwork", "TransitNetwork_ND")
PED_NETWORK = os.path.join(INPUT, "Network", "TransportNetwork.gdb", "PedestrianNetwork", "PedestrianNetwork_ND")
...
# TRANSPORTATION
NETWORK_NAME_FOR_MODE = {"vehicle": VEHICLE_NETWORK, "transit": TRANSIT_NETWORK, "walk": PED_NETWORK,
                         "bike": BIKE_NETWORK}
TRANSPORT_MODES = ("vehicle", "transit", "walk", "bike")
...
def str_to_bool(string):
    """
    Turns a string into the associated boolean.
    :param string: bool to convert
    :return: boolean
    """
